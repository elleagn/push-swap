...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   test_cheapest_move_element.c                       :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: gozon <gozon@student.42.fr>                +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/28 11:38:06 by gozon             #+#    #+#             */
/*   Updated: 2024/08/29 10:29:29 by gozon            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	update_r_rr(int pos_a, int pos_b, t_push_swap *push_swap)
{
	...
	if (pos_b > push_swap->size_b - pos_b)
	{
		...
		push_swap->next_move->rrb = push_swap->size_b - pos_a;
	}
	else
	{
...
int	main(int ac, char **av)
{
	...
	if (!push_swap)
		return (1);
	push_swap->size = ft_atoi(av[4]);
	push_swap->size_b = ft_atoi(av[3]);
	push_swap->next_move->total = ft_atoi(av[4]);
	cheapest_move_by_element(ft_atoi(av[1]), ft_atoi(av[2]), push_swap);
	ft_printf("ra: %i\n", push_swap->next_move->ra);
	ft_printf("rb: %i\n", push_swap->next_move->rb);
	ft_printf("rr: %i\n", push_swap->next_move->rr);
	ft_printf("rra: %i\n", push_swap->next_move->rra);
	ft_printf("rrb: %i\n", push_swap->next_move->rrb);
	ft_printf("rrr: %i\n", push_swap->next_move->rrr);
	ft_printf("total: %i\n", push_swap->next_move->total);
	cleanup(push_swap);
	return (0);
}
